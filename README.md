...
| `zigbee2mqtt_aqara_mini_switch` | Zigbee2MQTT template for [Xiaomi Aqara wireless switch](https://www.zigbee2mqtt.io/devices/WXKG11LM.html#xiaomi-wxkg11lm) | ***_button_***, battery_power, temperature_sensor, value_sensor | x_mqtt_device.poll[^3] | zigbee2mqtt.zip |
| `zigbee2mqtt_aqara_occupancy_illuminance` | Zigbee2MQTT template for [Aqara human body movement and illuminance sensor](https://www.zigbee2mqtt.io/devices/RTCGQ11LM.html#xiaomi-rtcgq11lm) | ***_motion_sensor_***, light_sensor, battery_power, voltage_sensor, temperature_sensor, value_sensor | x_mqtt_device.poll[^3] | zigbee2mqtt.zip |
| `zigbee2mqtt_aqara_illuminance_occupancy` | Zigbee2MQTT template for [Aqara human body movement and illuminance sensor](https://www.zigbee2mqtt.io/devices/RTCGQ11LM.html#xiaomi-rtcgq11lm) | ***_light_sensor_***, motion_sensor, battery_power, voltage_sensor, temperature_sensor, value_sensor | Same as the above but with light_sensor.value as primary attribute. | zigbee2mqtt.zip |
| `zigbee2mqtt_aqara_temperature_humidity` | Zigbee2MQTT template for [Xiaomi Aqara temperature, humidity and pressure sensor](https://www.zigbee2mqtt.io/devices/WSDCGQ11LM.html) | ***_temperature_sensor_***, humidity_sensor, battery_power, voltage_sensor, value_sensor, string_sensor | x_mqtt_device.poll[^3] | zigbee2mqtt.zip |
| `zigbee2mqtt_aqara_humidity_temperature` | Zigbee2MQTT template for [Xiaomi Aqara temperature, humidity and pressure sensor](https://www.zigbee2mqtt.io/devices/WSDCGQ11LM.html) | ***_humidity_sensor_***, temperature_sensor, battery_power, voltage_sensor, value_sensor, string_sensor | Same as the above but with humidity_sensor.value as primary attribute. | zigbee2mqtt.zip |
| `zigbee2mqtt_generic_power_switch` | Zigbee2MQTT template for generic power_switch. | ***_power_switch_***, value_sensor, string_sensor, toggle | - | zigbee2mqtt.zip |
| `zigbee2mqtt_generic_power_switch_pm` | Zigbee2MQTT template for generic power_switch with power moitoring. | ***_power_switch_***, power_sensor, current_sensor, energy_sensor, voltage_sensor, value_sensor, string_sensor, toggle | - | zigbee2mqtt.zip |
...
| `zigbee2mqtt_tradfri_light_bulb_d` | Zigbee2MQTT template for [IKEA TRADFRI LED bulb E26/E27 806 lumen, dimmable, warm white](https://www.zigbee2mqtt.io/devices/LED1836G9.html#ikea-led1836g9) | ***_dimming_***, power_switch, light_effect, value_sensor, string_sensor, toggle | Same as the above but with dimming.level as primary attribute. | zigbee2mqtt.zip |
...
| `zigbee2mqtt_tradfri_light_bulb_ws_d` | Zigbee2MQTT template for [IKEA TRADFRI bulb E12/E14/E17 WS 450/470/440 lumen, dimmable, white spectrum, opal white](https://www.zigbee2mqtt.io/devices/LED1903C5_LED1835C6.html#ikea-led1903c5%252Fled1835c6) | ***_dimming_***, power_switch, color_temperature, light_effect, value_sensor, string_sensor, toggle | Same as the above but with dimming.level as primary attribute. | zigbee2mqtt.zip |
| `zigbee2mqtt_tuya_2_gang_switch` | Zigbee2MQTT template for [Tuya TS0002](https://www.zigbee2mqtt.io/devices/TS0002.html#tuya-ts0002) | Requires requires: [endpoint], ***_power_switch_***, value_sensor | - | zigbee2mqtt.zip |
| `zigbee2mqtt_tuya_door_sensor` | Zigbee2MQTT template for [Sonoff Contact sensor](https://www.zigbee2mqtt.io/devices/SNZB-04.html#sonoff-snzb-04) | ***_door_sensor_***, battery_power, value_sensor | x_mqtt_device.poll[^3] | zigbee2mqtt.zip |
| `zigbee2mqtt_tuya_leak_sensor` | Zigbee2MQTT template for [Aubess IH-K665](https://www.zigbee2mqtt.io/devices/IH-K665.html#aubess-ih-k665) | ***_leak_detector_***, battery_power, value_sensor | x_mqtt_device.poll[^3] | zigbee2mqtt.zip |
| `zigbee2mqtt_tuya_occupancy_illuminance` | Zigbee2MQTT template for [TuYa Luminance motion sensor](https://www.zigbee2mqtt.io/devices/ZG-204ZL.html#tuya-zg-204zl) | ***_motion_sensor_***, light_sensor, battery_power, value_sensor | x_mqtt_device.poll[^3] | zigbee2mqtt.zip |
| `zigbee2mqtt_tuya_illuminance_occupancy` | Zigbee2MQTT template for [TuYa Luminance motion sensor](https://www.zigbee2mqtt.io/devices/ZG-204ZL.html#tuya-zg-204zl) | ***_light_sensor_***, motion_sensor, battery_power, value_sensor | x_mqtt_device.poll[^3] | zigbee2mqtt.zip |

All Zigbee2MQTT devices supporting OTA firmware updates will have either "available", "updating" or "idle" in the `string_sensor.value`
